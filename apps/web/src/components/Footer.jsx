      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-xs text-slate-600 dark:text-purple-200/50">
              Connecting Aboriginal and Torres Strait Islander peoples with meaningful employment, training, and mentorship opportunities.
            </p>
          </div>
        ...
        >
          <p className="text-center sm:text-left text-slate-500 dark:text-purple-200/60">
            <span className="text-purple-600 dark:text-[#FFD700]">✦</span> We acknowledge the Traditional Custodians of the lands on which we live and work, and pay our respects to Elders past and present. <span className="text-emerald-600 dark:text-[#50C878]">✦</span>
          </p>
          <p className="whitespace-nowrap text-slate-500 dark:text-purple-200/50">
            © {currentYear} Ngurra Pathways · Built by <span className="text-purple-700 dark:text-[#FFD700]">Munyaradzi Chenjerai</span>
          </p>
        </div>
      </div>
    </footer>
