    ...
    <div className={`${spaceGrotesk.className} ngurra-page`}>
          ...
          <aside className="hidden lg:block lg:col-span-3">
            <div className="sticky top-20 space-y-4">
              ...
              <div className="rounded-xl p-4 bg-white dark:bg-white/5 backdrop-blur-md border border-gray-200 dark:border-white/10 shadow-sm dark:shadow-none">
                <h3 className="text-sm font-semibold mb-3 text-emerald-600 dark:text-emerald-400">Quick Actions</h3>
                <div className="space-y-1">
                  <Link href="/social-feed/new" className="flex items-center gap-2 p-2 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 transition-colors">
                    <Sparkles className="w-4 h-4 text-amber-500 dark:text-amber-400" />
                    Create Post
                  </Link>
                  <Link href="/jobs" className="flex items-center gap-2 p-2 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 transition-colors">
                    <Briefcase className="w-4 h-4 text-blue-500 dark:text-blue-400" />
                    Browse Jobs
                  </Link>
                  <Link href="/events" className="flex items-center gap-2 p-2 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 transition-colors">
                    <Calendar className="w-4 h-4 text-pink-500 dark:text-pink-400" />
                    Upcoming Events
                  </Link>
                  <Link href="/mentorship" className="flex items-center gap-2 p-2 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 transition-colors">
              ...
              {/* Trending Topics */}
              <div className="rounded-xl p-4 bg-white dark:bg-white/5 backdrop-blur-md border border-gray-200 dark:border-white/10 shadow-sm dark:shadow-none">
                <h3 className="text-sm font-semibold mb-3 text-amber-600 dark:text-amber-400">Trending Topics</h3>
          ...
          <main className="lg:col-span-6">
              ...
              <div className="flex gap-3 pb-2">
                ...
                {[
                  ...
                  <button key={i} className="flex flex-col items-center gap-1 shrink-0">
                    ...
                    <span className="text-[10px] text-gray-500 dark:text-gray-400 truncate w-16 text-center">{story.name}</span>
                  </button>
                ))}
              </div>
            </div>
            ...
            {isAuthenticated ? (
              ...
              <div className="rounded-xl p-4 mb-6 bg-white dark:bg-white/5 backdrop-blur-md border border-gray-200 dark:border-white/10 shadow-sm dark:shadow-none text-center">
                <p className="text-gray-600 dark:text-gray-400 mb-2">Join the community to share your story</p>
                <a href="/signin?returnTo=/social-feed" className="inline-block px-5 py-2 rounded-lg font-medium bg-gradient-to-r from-emerald-600 to-emerald-500 text-white hover:from-emerald-500 hover:to-emerald-400 transition-all text-sm">
                  Sign In
                </a>
              </div>
            )}
            ...
            <div className="sticky top-20 space-y-4">
              ...
              <div className="rounded-xl p-4 bg-white dark:bg-white/5 backdrop-blur-md border border-amber-300/40 dark:border-amber-500/30 shadow-sm dark:shadow-none">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-sm font-semibold text-amber-600 dark:text-amber-400">Partner Opportunities</h3>
                  <span className="text-[10px] px-2 py-0.5 rounded bg-amber-100 dark:bg-amber-500/20 text-amber-600 dark:text-amber-400">AD</span>
                </div>
                <div className="space-y-2">
                  {partners.map((partner, i) => (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-900 dark:text-white text-sm">{partner.name}</span>
                      </div>
                      <span className="text-xs px-2 py-0.5 rounded-full bg-emerald-100 dark:bg-emerald-500/20 text-emerald-700 dark:text-emerald-400">
                        {partner.jobs} jobs
                      </span>
              ...
              <div className="rounded-xl p-4 bg-white dark:bg-white/5 backdrop-blur-md border border-gray-200 dark:border-white/10 shadow-sm dark:shadow-none">
                ...
                <div className="grid grid-cols-2 gap-3 text-center">
                  <div className="bg-gray-50 dark:bg-white/5 rounded-lg p-2">
                    <div className="text-lg font-bold text-amber-600 dark:text-amber-400">12.5K</div>
                    <div className="text-[10px] text-gray-500">Jobs Filled</div>
                  </div>
                  <div className="bg-gray-50 dark:bg-white/5 rounded-lg p-2">
                    <div className="text-lg font-bold text-emerald-600 dark:text-emerald-400">8.2K</div>
              ...
              <div className="text-center py-3">
                <p className="text-[10px] text-gray-500">
                  <span className="text-amber-500 dark:text-amber-400">✦</span> We acknowledge Traditional Custodians <span className="text-emerald-500 dark:text-emerald-400">✦</span>
                </p>
              </div>
            </div>
          </aside>
      ...
      <nav className="fixed bottom-0 left-0 right-0 lg:hidden bg-gradient-to-t from-white to-white/95 dark:from-[#1A0F2E] dark:to-[#1A0F2E]/95 backdrop-blur-lg border-t border-gray-200 dark:border-white/10 z-50">
        <div className="flex justify-around items-center py-2 px-4">
          <Link href="/" className="flex flex-col items-center gap-1 p-2 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
            </svg>
            <span className="text-[10px]">Home</span>
          </Link>
          <Link href="/social-feed" className="flex flex-col items-center gap-1 p-2 text-amber-600 dark:text-amber-400 transition-colors">
            <Sparkles className="w-6 h-6" />
          ...
          <Link href="/jobs" className="flex flex-col items-center gap-1 p-2 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
            <Briefcase className="w-6 h-6" />
            <span className="text-[10px]">Jobs</span>
          </Link>
          <Link href="/profile" className="flex flex-col items-center gap-1 p-2 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
