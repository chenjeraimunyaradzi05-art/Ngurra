          ...
          >
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <div
                  className="border-2 border-dashed border-white/20 rounded-xl p-6 text-center hover:border-teal-500/50 transition-colors cursor-pointer"
                  style={{ background: 'rgba(255, 255, 255, 0.02)' }}
                >
                  <FileText className="w-8 h-8 mx-auto text-gray-500 mb-2" />
                  <p className="text-sm text-gray-400">Upload floor plan (PDF or image)</p>
                </div>
              </div>
