...
export function createApp() {
  ...
  const allowedOrigins = (
    ...
    'http://localhost:3000,http://127.0.0.1:3000,http://localhost:3001,http://127.0.0.1:3001,https://tinashe.life,https://www.tinashe.life,https://tinashe-life.netlify.app,https://Tinashepathways.com.au,https://www.Tinashepathways.com.au'
  )
    .split(',')
    .map((s) => s.trim())
    .filter(Boolean);
